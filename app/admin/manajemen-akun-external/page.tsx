    ...
    <div className="p-10 relative font-primary">
      ...
      <div className="bg-white/70 backdrop-blur-md rounded-[32px] shadow-sm border border-white/20 p-8 mb-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-2 block ml-1">Status</label>
            <select
                    ...
                    <td className="px-8 py-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-[10px] text-gray-400 font-bold uppercase tracking-tighter">{user.email} • {user.nomor_telepon || 'No Phone'}</span>
                        </div>
                      </div>
                    </td>
                    <td className="px-8 py-6">
