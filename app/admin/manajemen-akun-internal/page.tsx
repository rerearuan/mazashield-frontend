  ...
  return (
    <div className="p-10 relative font-primary">
      ...
      <div className="bg-white/70 backdrop-blur-md rounded-[32px] shadow-sm border border-white/20 p-8 mb-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="md:col-span-2">
            <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-2 block ml-1">Cari Anggota</label>
          ...
          <div>
            <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-2 block ml-1">Role</label>
            <select
      ...
      <ConfirmationModal
        ...
        title={userToToggle?.is_active ? "Nonaktifkan Akun" : "Aktifkan Akun"}
        message={`Apakah Anda yakin ingin ${userToToggle?.is_active ? 'menonaktifkan' : 'mengaktifkan kembali'} akses untuk ${userToToggle?.nama}?`}
        confirmText={userToToggle?.is_active ? "Ya, Nonaktifkan" : "Ya, Aktifkan"}
