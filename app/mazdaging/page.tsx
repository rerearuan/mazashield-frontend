          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-12">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="space-y-2">
                <label className="text-sm font-bold text-[#1a8245]">Cari Produk</label>
              ...
              <div className="space-y-2">
                <label className="text-sm font-bold text-[#1a8245]">Rentang Harga /kg (Rp)</label>
              ...
              <div className="space-y-2">
                <label className="text-sm font-bold text-[#1a8245]">Bagian Daging</label>
                <select
                  value={bagian}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                {products.length === 0 ? (
                  ...
                  products.map((item) => (
                    <ProductCard
                      key={item.id}
                      image={item.foto ? (item.foto.startsWith('http') ? item.foto : `${process.env.NEXT_PUBLIC_API_URL?.replace('/api', '')}${item.foto}`) : "/images/homepages/Logo-Mazdaging.png"}
                      title={item.nama}
